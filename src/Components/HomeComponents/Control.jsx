...
function Control() {
  ...
  return (
    <section className="col-span-3 grid grid-cols-3 gap-2">
      ...
      <div
        ...
        {periods.map((period) => (
          <span
            ...
            className={`px-2 py-1 bg-white-b2 dark:bg-black-b2 tracking-wide rounded-md cursor-pointer transition-colors duration-300 ${
              period === activePeriod && "bg-blue-200 dark:bg-blue-900"
            }`}>
            {period}
          </span>
        ))}
